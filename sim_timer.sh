#!/bin/bash
# this one simulates with hd44780_timer_tb
...
# - note has controller bc currently timer is not broken out
iverilog -D SIM_STEP -o hd44780_timer_tb.vvp hd44780_controller.v hd44780_timer_tb.v hd44780_syscon.v 1>> sim_tb_out.txt 2>> sim_tb_err.txt
